...
Les memes tris et filtres presents dans le front office le sont dans le back office.
...
-Le site est déployé et le serveur d'authentification Keycloack est configurée sur une vm en ligne.
